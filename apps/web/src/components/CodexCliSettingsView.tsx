...
function effectiveRows(settings: Settings, profile: RunnerProfile | null) {
  ...
  return [
    row("model", "model", "模型", "model"), row("reasoning_effort", "reasoning_effort", "思考等级", "model_reasoning_effort"), row("reasoning_summary", "reasoning_summary", "推理摘要", "model_reasoning_summary"), row("verbosity", "verbosity", "输出详细度", "model_verbosity"), row("personality", "personality", "Personality", "personality"), row("service_tier", "service_tier", "Fast 模式", "service_tier"), row("approval_policy", "approval_policy", "审批策略", "approval_policy"), row("sandbox_mode", "sandbox_mode", "沙盒等级", "sandbox_mode"), row("network_access", "network_access", "网络访问", "sandbox_workspace_write.network_access"), row("web_search", "web_search", "Web Search", "web_search"), row("feature_multi_agent", "feature_multi_agent", "多 Agent", "features.multi_agent"), row("feature_remote_plugin", "feature_remote_plugin", "插件", "features.remote_plugin"), row("feature_hooks", "feature_hooks", "Hooks", "features.hooks"), row("feature_goals", "feature_goals", "Goals", "features.goals"), row("feature_shell_tool", "feature_shell_tool", "Shell", "features.shell_tool"),
  ];
}
