...
const PERSONAL_AGENT_NAMES = [
  "林澈", "苏棠", "顾言", "沈岚", "陆川", "许宁", "江禾", "叶舟",
  "唐安", "宋知", "夏青", "温宁", "周屿", "陈墨", "乔木", "程野",
  "姜遥", "秦川", "白榆", "谢岑", "韩序", "简宁", "季衡", "洛嘉",
  "Maya", "Rowan", "Avery", "Morgan", "Jamie", "Riley", "Casey", "Quinn",
];

function suggestPersonalAgentName(agents: CompanyAgent[]) {
  const used = new Set(agents.map((agent) => agent.agent_profile.display_name));
