...
RELAY_DATA_HOME="${RELAY_DATA_HOME:-$ROOT_DIR}"
LOCAL_ENV_FILE="${RELAY_CONFIG_FILE:-$RELAY_DATA_HOME/.env.local}"
RUNTIME_DIR="${RELAY_RUNTIME_DIR:-$RELAY_DATA_HOME/.relay/runtime}"
...
export RELAY_DEFAULT_WORKSPACE_ROOT="${RELAY_DEFAULT_WORKSPACE_ROOT:-$RELAY_DATA_HOME/.relay-workspace}"
...
export RELAY_HOST_IMPORT_ROOT="${RELAY_HOST_IMPORT_ROOT:-$(dirname "$ROOT_DIR")}"
export RELAY_HOST_IMPORT_CONTAINER_ROOT="${RELAY_HOST_IMPORT_CONTAINER_ROOT:-/relay-host-imports}"
export HUMAN_FOLDER_REFERENCE_HOST_ROOT="${HUMAN_FOLDER_REFERENCE_HOST_ROOT:-$RELAY_HOST_IMPORT_ROOT}"
...
export AGENT_TRIGGER_MIN_AVAILABLE_MEMORY_MB="${AGENT_TRIGGER_MIN_AVAILABLE_MEMORY_MB:-1536}"
...
export RELAY_CHROME_PAGE_IDLE_TIMEOUT_SECONDS="${RELAY_CHROME_PAGE_IDLE_TIMEOUT_SECONDS:-300}"
export RELAY_CHROME_MAX_IDLE_PAGES="${RELAY_CHROME_MAX_IDLE_PAGES:-2}"
...
start_trigger() {
  ...
  trigger_command=(
    ...
    "AGENT_TRIGGER_MIN_AVAILABLE_MEMORY_MB=$AGENT_TRIGGER_MIN_AVAILABLE_MEMORY_MB"
    ...
    "RELAY_CHROME_PAGE_IDLE_TIMEOUT_SECONDS=$RELAY_CHROME_PAGE_IDLE_TIMEOUT_SECONDS"
    "RELAY_CHROME_MAX_IDLE_PAGES=$RELAY_CHROME_MAX_IDLE_PAGES"
