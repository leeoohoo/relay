...
use ai_chat_domain::company::{
    ...
    AGENT_CODEX_APPROVAL_TOOL_WEBSITE_ACCESS, AGENT_CODEX_SANDBOX_READ_ONLY,
    AGENT_CODEX_SANDBOX_WORKSPACE_WRITE, AGENT_CODEX_SESSION_KIND_CONTROL,
    ...
    AGENT_CODEX_TRIGGER_TYPE_SCHEDULED, AGENT_CODEX_TRIGGER_TYPE_TASK,
    AGENT_EXECUTION_INTENT_STATUS_FAILED, AGENT_EXECUTION_INTENT_STATUS_PENDING,
    AGENT_EXECUTION_INTENT_STATUS_RUNNING, AGENT_MEMORY_INJECTION_ALWAYS,
    AGENT_MEMORY_INJECTION_ON_DEMAND, AGENT_MEMORY_SCOPE_AGENT, AGENT_MEMORY_SCOPE_CONTROL,
    ...
    AGENT_MEMORY_TIER_LONG_TERM, AGENT_MEMORY_TIER_SHORT_TERM, AGENT_MEMORY_VISIBILITY_BOTH,
    AGENT_MEMORY_VISIBILITY_CONTROL, AGENT_MEMORY_VISIBILITY_WORKER,
    ...
    PROJECT_TASK_STATUS_IN_PROGRESS, PROJECT_TASK_STATUS_TODO, PROJECT_TYPE_SOURCE_DESCRIPTION,
    PROJECT_TYPE_SOURCE_FOLDER, PROJECT_TYPE_SOURCE_HUMAN, PROJECT_TYPE_SOURCE_SYSTEM,
