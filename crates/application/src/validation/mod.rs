...
use ai_chat_domain::company::{
    ...
    PROJECT_TASK_DEPENDENCY_COMPLETION, PROJECT_TASK_DEPENDENCY_FAILURE,
    PROJECT_TASK_DEPENDENCY_SUCCESS, PROJECT_TASK_PRIORITY_HIGH, PROJECT_TASK_PRIORITY_LOW,
    ...
    PROJECT_TASK_STATUS_IN_PROGRESS, PROJECT_TASK_STATUS_TODO,
};
